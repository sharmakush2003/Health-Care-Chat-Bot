...
export default function AdminDashboard() {
    ...
    const [simPhone, setSimPhone] = useState('+91 90450 99111');
                    ...
                    <div className="flex-1 overflow-y-auto space-y-3 pr-1">
                        {messages.length === 0 ? (
                            <div className="text-center py-12 text-slate-400 text-sm">
                                No WhatsApp messages received yet. Send a test message below!
                            </div>
                        ) : (
                            messages.map((msg) => (
                                <div key={msg.id} className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl space-y-2 text-xs hover:border-teal-300 transition">
                                    ...
                                    <div className="bg-teal-50/80 p-2.5 rounded-lg border border-teal-200 text-teal-900 text-[11px] whitespace-pre-line leading-relaxed">
                                        <div className="font-semibold text-teal-800 flex items-center justify-between mb-1">
                                            <span>🤖 Khaira Medical Bot (Auto-Reply):</span>
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3">
                    <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                        <h3 className="font-bold text-slate-900 text-sm flex items-center gap-2">
                            ...
                            Meta WhatsApp Cloud API Webhook Status
                        </h3>
                    ...
                    <div className="space-y-2 font-mono text-xs text-slate-700 bg-slate-50 p-3.5 rounded-xl border border-slate-200">
                        <div>
                            ...
                            <div className="text-teal-700 font-bold break-all">http://localhost:3000/api/webhook</div>
                        </div>
                        <div className="pt-2 border-t border-slate-200">
                            <span className="text-slate-400">Verification Token:</span>
                            <div className="text-slate-900 font-bold">automatex_healthcare_token</div>
                        </div>
                        <div className="pt-2 border-t border-slate-200">
                            <span className="text-slate-400">Supported Payloads:</span>
                            <div className="text-slate-900 font-semibold">Text, Interactive Lists, Buttons, Flows</div>
                        </div>
                    </div>
                </div>
            </div>
